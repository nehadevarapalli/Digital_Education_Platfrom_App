...
//  }
  ...
  public void createPerson(String email) {
    ...
    person.setNuId(persons.getPersons().size());
    us.setPerson(person);
    us.setUserId(users.getUsers().size());
    users.add(us);
    persons.add(person); 
   ...
   public void updateUser(User user, String username, String plaintextPassword, String enabled, String role, String email) {
